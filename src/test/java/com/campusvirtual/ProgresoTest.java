...
public class ProgresoTest {
    ...
    void shouldInitializeWithZeroPercentProgressAndEmptyCompletedListWhenStudentEnrolls() {
        // Arrange
        Curso curso = crearCurso("Java Avanzado");
    ...
    void shouldAllowCompletingTheFirstContenidoDirectlyWithoutAnyPredecessors() {
        // Arrange
        Curso curso = crearCurso("Java Avanzado");
        Modulo modulo = new Modulo("Introducción");
        Contenido contenido1 = new Contenido("Variables", 1);
    ...
    void shouldThrowIllegalStateExceptionWhenAttemptingToCompleteContenidoWithPendingPredecessors() {
        ...
        Modulo modulo = new Modulo("Introducción");
        Contenido contenido1 = new Contenido("Variables", 1);
        Contenido contenido2 = new Contenido("Bucles", 2);
    ...
    void shouldCalculateAccurateProgressPercentageBasedOnTotalCompletedContenidos() {
        ...
        Contenido contenido1 = new Contenido("Variables", 1);
        Contenido contenido2 = new Contenido("Bucles", 2);
        Contenido contenido3 = new Contenido("Métodos", 3);
        Contenido contenido4 = new Contenido("Clases", 4);
    ...
    void shouldReturnZeroPercentProgressWhenCourseDoesNotContainAnyContenidos() {
        // Arrange
        Curso curso = crearCurso("Java Vacío"); // Curso creado sin módulos ni contenidos
        Progreso progreso = new Progreso("estudiante-123", curso);
    ...
    private Curso crearCurso(String titulo) {
        Notificador notificador = org.mockito.Mockito.mock(Notificador.class);
        return new Curso(titulo, "Descripción", notificador);
    }
}